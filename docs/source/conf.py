...
latex_documents = [
    (master_doc, "omfvista.tex", "omfvista Documentation", "Bane Sullivan", "manual"),
]
...
man_pages = [(master_doc, "omfvista", "omfvista Documentation", [author], 1)]
